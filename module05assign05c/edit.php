...
$DeptID = $database->real_escape_string(htmlspecialchars($_POST['DeptID']));
...
echo "ajksdhaksd";
echo $firstname,$lastname,$DeptID,$id;
$sql ="UPDATE karanjitsu_Company.Employee_Information SET First_Name='$firstname', Last_Name='$lastname' , DeptID ='$DeptID' WHERE Employee_Information.EMPID=$id";
