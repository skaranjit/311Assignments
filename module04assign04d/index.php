...
HERE;
                        ...
                        function afterSelected($uName,$pass,$dbName,$button,$btn,&$Name,&$Description){
...
HERE;
                            ...
                            $result = mysqli_query($conn,$sql);
                            mysqli_close($conn);
                            printtable("Query Results",$result,$uName,$pass,$dbName,$btn,$button);
                            }
...
HERE;
                        ...
                        function printtable($tablename,$result,$uName,$pass,$dbName,$btn,$button)
                        {
...
HERE;
                           ...
                           while ($row = mysqli_fetch_assoc($result))
                           {
                              ...
                              echo '<td>';
                              echo '<a href="edit.php?uName='.$uName.'&pass='.$pass.'&dbName='.$dbName.'&btn='.$btn.'&button='.$button.'&id=' . $row['EMPID'] . '">Edit</a></td>';
                              echo '<td><a href="delete.php?uName='.$uName.'&pass='.$pass.'&dbName='.$dbName.'&btn='.$btn.'&button='.$button.'&id=' . $row['EMPID'] . '">Delete</a></td>';
                              echo "</tr>\n";
                           }
                           echo "</tbody></table>";
                        }
