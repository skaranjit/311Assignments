...
HERE;
                            ...
                            // Note that I made this generic to work with any table in a DB.
                            // You could write it for a specific DB by just using known names.
                            $sql = "select distinct First_Name from Employee_Information";
                            $result = mysqli_query($conn,$sql);
...
HERE;
                            ...
                            // Note that I made this generic to work with any table in a DB.
                            // You could write it for a specific DB by just using known names.
                            $sql = "select distinct Gender from Employee_Information";
                            $result = mysqli_query($conn,$sql);
...
HERE;
                        ...
                        elseif ($button == "Send Query"){
                            ...
                            else
                            {
                                ...
                                $sql = "select " . $thefields . " from Employee_Information";
                            }
